...
if(isset($_POST['contact-submit'])) {
    ...
    echo "<br><br>";
    echo "<h2 style='text-align:center;'>Wij hebben uw bericht ontvangen!</h2>";
    echo "<h4 style='text-align:center;'>U zult spoedig van ons horen</h4>";

} else {

    echo "<i class='far fa-times-circle'></i>";
    echo "<br><br>";
    echo "<h2 style='text-align:center;'>Er gaat iets fout</h2>";
    echo "<h4 style='text-align:center;'>Probeer het alstublieft later opnieuw</h4>";
